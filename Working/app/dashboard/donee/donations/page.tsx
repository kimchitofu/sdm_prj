...
// Demo data: donations linked to fundraising activities for this Donee.
// For now, this uses mock data. Later, replace this with an API call that filters
// campaigns where the current Donee is the beneficiary.
const doneeDonations = donations.slice(0, 15).map((donation) => ({
  ...donation,
  campaign: campaigns.find((campaign) => campaign.id === donation.campaignId) || campaigns[0],
}))

const totalReceived = doneeDonations.reduce((sum, donation) => sum + donation.amount, 0)

const linkedCampaigns = new Set(doneeDonations.map((donation) => donation.campaignId)).size
    ...
    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatsCard
          ...
          value={linkedCampaigns.toString()}
          ...
          <CardContent className="py-16 text-center">
            ...
            <p className="text-muted-foreground mb-4 max-w-md mx-auto">
              {searchQuery || categoryFilter !== "all" || dateFilter !== "all"
                ? "Try adjusting your filters to find received donations."
                : "No donations have been received for your linked fundraising activities yet."}
            </p>
            ...
            {searchQuery || categoryFilter !== "all" || dateFilter !== "all" ? (
              ...
              <Link href="/dashboard/donee">
                <Button>View Fundraising Activities</Button>
              </Link>
            )}
          </CardContent>
        </Card>
