    ...
    return (
      <main className="max-w-4xl mx-auto p-8">
        <div className="rounded-lg border border-red-300 bg-red-50 p-6 text-center">
          <p className="font-semibold text-red-600">Campaign not found</p>
    ...
    <main className="max-w-5xl mx-auto p-8 space-y-8">
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 mt-1">
              You can view campaign details, progress, updates, recent
              donations, and impact information before donating. No account is
              required to donate as a guest.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-xl border bg-white p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 text-sm">
          ...
          <div className="rounded-lg bg-gray-50 p-4">
            ...
            <p className="text-xl font-semibold">{progress}% funded</p>
          </div>
        </div>

        <p className="mt-6 leading-relaxed">{campaign.description}</p>
      </section>
      ...
      <section className="rounded-xl border bg-white p-6 shadow-sm">
        ...
        <p className="text-gray-600 mb-5">
          This section helps guest users understand how their donation may
          support the campaign before they decide to donate.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-lg border p-4">
            <Gift className="h-6 w-6 mb-2 text-blue-600" />
            <p className="font-semibold">$10 Donation</p>
            <p className="text-sm text-gray-600">
              Helps provide basic support for the campaign.
            </p>
          </div>

          <div className="rounded-lg border p-4">
            <Heart className="h-6 w-6 mb-2 text-blue-600" />
            <p className="font-semibold">$50 Donation</p>
            <p className="text-sm text-gray-600">
              Helps create a stronger impact for beneficiaries.
            </p>
          </div>

          <div className="rounded-lg border p-4">
            <Users className="h-6 w-6 mb-2 text-blue-600" />
            <p className="font-semibold">$100 Donation</p>
            <p className="text-sm text-gray-600">
              Helps the campaign reach more people in need.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Campaign Updates */}
      <section className="rounded-xl border bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-semibold mb-4">Campaign Updates</h2>
            ...
            {campaign.updates.map((update) => (
              <div key={update.id} className="border rounded-lg p-4">
                ...
                <p className="text-sm text-gray-500 mt-2 flex items-center gap-1">
                  ...
                  {update.createdAt.toLocaleDateString("en-SG", {
                    day: "numeric",
                    month: "short",
                    year: "numeric",
                  })}
      ...
      {campaign.status === "locked" ? (
        <div className="flex items-center gap-3 rounded-lg border border-red-300 bg-red-50 px-5 py-4 text-red-600">
          ...
          <div>
            ...
            <p className="text-sm">
              This campaign has been flagged and is no longer accepting
              donations.
            </p>
          </div>
        </div>
