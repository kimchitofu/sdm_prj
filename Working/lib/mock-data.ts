...
export const auditLogs: AuditLogEntry[] = [
  {
    ...
    description: 'Account suspended due to suspicious fundraising activity',
  ...
  },
  {
    ...
    description: 'Campaign "Help Maya Get Her Life-Saving Surgery" published',
    performedBy: 'Sarah Chen',
    ipAddress: '203.15.44.21',
  ...
  },
  {
    ...
    description: 'Donation of $500 to "Help Maya Get Her Life-Saving Surgery"',
    performedBy: 'Michael Johnson',
    ipAddress: '74.125.22.11',
    createdAt: '2026-03-28T14:30:00Z',
  },
  {
    id: 'audit-4',
    ...
    description: 'Campaign "School Library Renovation Project" approved for publishing',
    performedBy: 'Admin User',
    ipAddress: '10.0.0.1',
  ...
  },
  {
    ...
    userId: 'user-9',
    action: 'admin_login',
    description: 'Login from unrecognized IP address flagged',
    performedBy: 'Suspended User',
    ipAddress: '185.220.101.5',
    createdAt: '2025-11-20T03:14:00Z',
  },
  {
    id: 'audit-6',
    userId: 'user-3',
    ...
    description: 'New campaign "Scholarships for Underprivileged STEM Students" submitted for review',
    performedBy: 'Emily Davis',
    ipAddress: '98.120.33.45',
    createdAt: '2026-02-28T10:00:00Z',
  },
  {
    id: 'audit-7',
  ...
  },
  {
    ...
    description: 'Account frozen pending fraud investigation',
    performedBy: 'Admin User',
    ipAddress: '10.0.0.1',
...
export const campaignReports: CampaignReport[] = [
  {
    ...
    campaignTitle: 'Youth Soccer League Equipment Fund',
    reportedById: 'user-2',
    reportedByName: 'Michael Johnson',
    reason: 'misleading_information',
    description: 'The campaign claims to support 300 kids but the organization only has 50 registered members. The target amount seems inflated.',
    status: 'pending',
  ...
  },
  {
    ...
    reason: 'fraud',
    description: 'I believe this campaign organizer has run similar campaigns in the past and disappeared with the funds. Please investigate.',
    status: 'under_review',
  ...
  },
  {
    id: 'report-c3',
    campaignId: 'camp-10',
    campaignTitle: 'Rural Clinic Medical Equipment Drive',
    reportedById: 'user-8',
    reportedByName: 'David Brown',
    reason: 'spam',
    description: 'This campaign appears to be a duplicate of another campaign already on the platform.',
    status: 'resolved',
    resolvedBy: 'Admin User',
    resolvedAt: '2026-03-31T10:00:00Z',
    resolution: 'Investigated and found to be a legitimate separate campaign. No action taken.',
  ...
  },
  {
    ...
    description: 'The gallery images contain graphic animal cruelty content that is disturbing.',
    status: 'dismissed',
    resolvedBy: 'Admin User',
    resolvedAt: '2026-04-01T08:00:00Z',
    resolution: 'Images reviewed and found appropriate for the context of wildlife rescue.',
    createdAt: '2026-04-01T07:30:00Z',
  },
]

// Message Reports
export const messageReports: MessageReport[] = [
  {
    id: 'report-m1',
    messageContent: 'Don\'t donate here, this is a scam. Send money directly to [external link] instead for guaranteed returns.',
    senderId: 'user-9',
    senderName: 'Suspended User',
    reportedById: 'user-2',
    reportedByName: 'Michael Johnson',
    reason: 'spam',
    description: 'User is posting spam links in campaign comments trying to redirect donations.',
    status: 'pending',
    createdAt: '2026-04-03T13:20:00Z',
  },
  {
    id: 'report-m2',
    messageContent: 'You should be ashamed running this campaign. This is obviously fake and you are stealing from people!',
    senderId: 'user-8',
    senderName: 'David Brown',
    reportedById: 'user-1',
    reportedByName: 'Sarah Chen',
    reason: 'harassment',
    description: 'User is leaving hostile and threatening messages on my campaign page.',
    status: 'under_review',
    createdAt: '2026-04-01T10:45:00Z',
  },
  {
    id: 'report-m3',
    messageContent: 'All profits from this campaign are mine. I copied this concept from [other platform] without permission.',
    senderId: 'user-9',
    senderName: 'Suspended User',
    reportedById: 'user-3',
    reportedByName: 'Emily Davis',
    reason: 'copyright_violation',
    description: 'Campaign organizer admitted to copying content from another platform.',
    status: 'resolved',
    createdAt: '2026-03-25T16:00:00Z',
  },
]

// Campaign Reviews (pending admin approval)
export const campaignReviews: CampaignReview[] = [
  {
    id: 'review-1',
    campaignId: 'camp-11',
    campaignTitle: 'School Library Renovation Project',
    campaignCategory: 'Education',
    campaignServiceType: 'education',
    targetAmount: 45000,
    organiserName: 'Sarah Chen',
    organiserEmail: 'sarah.chen@email.com',
  ...
  },
  {
    ...
    campaignTitle: 'Veterans Mental Health Support Network',
    campaignCategory: 'Community Projects',
    campaignServiceType: 'community',
    targetAmount: 60000,
    organiserName: 'Emily Davis',
    organiserEmail: 'emily.davis@email.com',
    isOrganiserVerified: true,
  ...
  {
    id: 'review-3',
    campaignId: 'camp-new-2',
    campaignTitle: 'Coastal Beach Cleanup Initiative',
    campaignCategory: 'Environment',
    campaignServiceType: 'environment',
    targetAmount: 12000,
    organiserName: 'Lisa Martinez',
    organiserEmail: 'lisa.martinez@email.com',
    isOrganiserVerified: true,
    submittedAt: '2026-04-04T10:30:00Z',
    status: 'under_review',
    reviewedBy: 'Admin User',
    notes: 'Checking organizer credentials and environmental impact claims.',
    flaggedIssues: ['Verify non-profit status', 'Confirm beach access permits'],
    coverImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800&h=400&fit=crop',
  },
  {
    id: 'review-4',
    campaignId: 'camp-new-3',
    campaignTitle: 'Cryptocurrency Investment Fund',
    campaignCategory: 'Business',
    campaignServiceType: 'business',
    targetAmount: 500000,
    organiserName: 'Suspicious User',
    organiserEmail: 'crypto.deals@tempmail.com',
    isOrganiserVerified: false,
    submittedAt: '2026-04-05T22:00:00Z',
    status: 'on_hold',
    reviewedBy: 'Admin User',
    notes: 'Suspicious campaign — unverified organizer, unusually high target, cryptocurrency focus violates platform guidelines.',
    flaggedIssues: ['Unverified organizer', 'Violates platform investment guidelines', 'Suspicious email domain', 'Excessive target amount'],
    coverImage: 'https://images.unsplash.com/photo-1518546305927-5a555bb7020d?w=800&h=400&fit=crop',
  },
  {
    id: 'review-5',
    campaignId: 'camp-new-4',
    campaignTitle: 'Children\'s Art Therapy Program',
    campaignCategory: 'Creative Arts',
    campaignServiceType: 'creative',
    targetAmount: 18000,
    organiserName: 'Emily Davis',
    organiserEmail: 'emily.davis@email.com',
    isOrganiserVerified: true,
    ...
    reviewedBy: 'Admin User',
    status: 'approved',
    coverImage: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=800&h=400&fit=crop',
  },
]
